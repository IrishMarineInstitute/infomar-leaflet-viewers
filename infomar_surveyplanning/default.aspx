...
<script runat="server">
	...
	if (!Request.IsLocal && !Request.IsSecureConnection)
	{
    		...
    		Response.Redirect("https://maps.marine.ie/infomar_surveyplanning/index.html", false);
...
<!-- 	<link rel="stylesheet" href="scripts/libs/leaflet-1.0.0-b1/leaflet.css" /> 
     ...
     <script src="scripts/tools/Leaflet.draw/dist/leaflet.draw.js"></script> -->
...
<!-- 	<script src="scripts/libs/leaflet-1.0.0-b1/leaflet-src.js" type="text/javascript"></script> 
	...
	<link rel="stylesheet" href="scripts/libs/leaflet-1.0.3/leaflet.css" />
	<script src="scripts/libs/leaflet-1.0.3/leaflet-src.js" type="text/javascript"></script> 
	<script src="scripts/libs/esri-leaflet-v2.0.8/esri-leaflet.js" type="text/javascript"></script>
	
		<!-- <script src="scripts/libs/ajax/leaflet.ajax	.js" type="text/javascript"></script> -->
	...
	<link rel="stylesheet" href="scripts/map/Leaflet.StyledLayerControl/css/styledLayerControl.css" />
	<script src="scripts/map/Leaflet.StyledLayerControl/src/styledLayerControl_edited.js" type="text/javascript"></script>
	<!-- <script src="https://unpkg.com/pouchdb@^5.2.0/dist/pouchdb.js"></script>
	<script src="scripts/map/L.TileLayer.PouchDBCached.js" type="text/javascript"></script> -->
	<script src="scripts/map/fallback.js" type="text/javascript"></script>
	
	<script type="text/javascript" src="scripts/map/Leaflet.Graticule.js"></script>
	<script src="scripts/display/Spin.js" type="text/javascript"></script> 
	<script type="text/javascript" src="scripts/tools/liveupdate/leaflet-liveupdate.js"></script>
	<link rel="stylesheet" href="scripts/tools/liveupdate/leaflet-liveupdate.css" />
	<script type="text/javascript" src="scripts/tools/fileLayer/leaflet.ajax.min.js"></script>
 	<script src="https://unpkg.com/togeojson@0.14.2"></script>
<!-- 	<script type="text/javascript" src="scripts/tools/fileLayer/leaflet.filelayer2.js"></script> -->
<!-- 	<link rel="stylesheet" href="scripts/tools/fileLayer/style.css" /> -->
	<!-- <script src='scripts/tools/leaflet-workspace/js/leaflet.spin.js'></script> -->
<!--  <script src='scripts/tools/leaflet-workspace/jam/require_edited.js'></script><script src="scripts/tools/leaflet-workspace/leaflet-workspace-edited.js"></script>
<script src="scripts/tools/leaflet-workspace/leaflet-workspace-csv.js"></script>  -->
		<script src="https://cdn.polyfill.io/v2/polyfill.min.js?features=Promise"></script>
		<script src="scripts/map/leaflet-bing/leaflet-bing-layer.js"></script>
		<link rel="stylesheet" href="scripts/map/osm-geocoder/control.OSMGeocoder.css" />
		<script src="scripts/map/osm-geocoder/control.OSMGeocoder.js"></script>
		<link rel="stylesheet" href="scripts/map/search_Surveys/control.searchSurveys.css" />
		<script src="scripts/map/search_Surveys/control.searchSurveys.js"></script>
...
<!-- <script src="//cdn.jsdelivr.net/leaflet.esri.renderers/2.0.4/esri-leaflet-renderers.js"></script> -->
...
<body>
	<div id="container">
		<div id="map"></div>
		<div id ="surveysListDiv" class="leaflet-bar noPrint">
			<div id ="surveysList" class="leaflet-bar noPrint">
			</div>
		<button id="surveysListClose">Close</button>
		</div>
		<div id ="surveysError" class="leaflet-bar noPrint">
		<div>Survey not found.  Would you like to view a list of all INFOMAR/INSS surveys</div>
		<div>
		<button id="viewList">View List</button>
		<button class="close">Cancel</button>
		</div>
		</div>
		<div id="selectedFeatures" class="leaflet-bar map-text ">Hover for Survey Information </div>
		<div id="printlegend">
				<div id="bathylegend">
					<img id="colorLeg" alt="Legend" src="images/0_5000m.png" />
				</div>	
				<div id="vectorLeg"></div>
				<div>
				<div><img id="printLogoBathy" class="printLogo" src="images/INFOMAR_logo_C.png" alt="N"><br></div>
				</div>
				<div id="shadedlegend">	
					...
					<img id="shadedimg"src="images/SR_Leg.png" alt="ShadedLegendImg" />
						...
						<img id="printLogoShaded" class="printLogo" src="images/INFOMAR_logo_C.png" alt="N">
						</div>
					</div>
				</div>
				<div id='disclaimer'>
		...
		<div id="form-Shading" class="leaflet-bar noPrint">
            <div id="toolbar_shaded" class="ui-widget-header ui-corner-all">
               <!--  <span id="shadedlayerOnOff">
                    <input type="radio" id="repeat0_Shaded" name="repeat_Shaded" autocomplete="off"><label for="repeat0_Shaded" id="shaded0Label">On</label>
                    <input type="radio" id="repeat1_Shaded" name="repeat_Shaded" checked="checked" autocomplete="off"><label for="repeat1_Shaded" id="shaded1Label">Off</label>
                </span> -->
        ...
        <div id="depth-ranges" draggable="true" class="leaflet-bar noPrint">
            <div id="toolbar" class="ui-widget-header ui-corner-all">
             <!--    <span id="layerOnOff">
                    <input type="radio" id="repeat0" name="repeat"  autocomplete="off"><label for="repeat0" id="repeat0Label">On</label>
                    <input type="radio" id="repeat1" name="repeat" checked="checked" autocomplete="off"><label for="repeat1" id="repeat1Label">Off</label>
                </span> -->
			...
			<div><div style="display:inline-block; vertical-align:top; text-align:left; padding:5px 0 0 0;"><p style="margin-bottom:40px;">	
                    ...
                    <input id='to' type="text" value='50' name='to' title="Change maximum depth (or elevation), use - sign for depths below sea level and + sign for elevation above sea level"></label></p>
					                        <label for="from">
                                 Minimum value:
                            <input id='from' type="text" value='-5000' name='from' title="Change minimum depth (or elevation), use - sign for depths below sea level and + sign for elevation above sea level">
                        </label></div>
	...
	<script src="scripts/map/print.js" type="text/javascript"></script>
	<script src="scripts/map/token2.js" type="text/javascript"></script>
	<script src="scripts/map/controls5.js" type="text/javascript"></script>
