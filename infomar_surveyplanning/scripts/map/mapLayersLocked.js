...
var PlannedSurveys = L.geoJSON(plannedSurveys, {
    ...
    if (feature.properties && feature.properties.Vessel) {
        layer.bindPopup("Vessel: " + feature.properties.Vessel + '<br>' + "Year: " + feature.properties.Year);
    }
}
});

var ISU = L.geoJSON(ISU_EEZ, {
    style: {color: "#555"},
	onEachFeature: function (feature, layer) {
    // does this feature have a property named popupContent?
    if (feature.properties && feature.properties.GRID_NO) {
        layer.bindPopup("Grid No.: " + feature.properties.GRID_NO + '<br>' + "Grid Code: " + feature.properties.grid_code);
    }
}
});
...
Admiralty_S57_300k.on('add', function(){
