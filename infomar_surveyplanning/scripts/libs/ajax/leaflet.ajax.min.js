...
<html lang="en">
  ...
  <meta name="request-id" content="6CEF:6B25:F3A314:16CFE4B:58DA5E7A" data-pjax-transient>
...
<meta content="collector.githubapp.com" name="octolytics-host" /><meta content="github" name="octolytics-app-id" /><meta content="https://collector.githubapp.com/github-external/browser_event" name="octolytics-event-url" /><meta content="6CEF:6B25:F3A314:16CFE4B:58DA5E7A" name="octolytics-dimension-request_id" />
<meta content="/&lt;user-name&gt;/&lt;repo-name&gt;/blob/show" data-pjax-transient="true" name="analytics-location" />
  ...
  <meta name="user-login" content="">
    ...
    <meta name="js-proxy-site-detection-payload" content="Zjk1YmZlYTFhNmI4NzNkNjRmMjg5M2Y4YzU4MGRkYzMwZTdlMDFhNGZlZTlkMmRiMmIxYTRmZTE3YzEzZTEyMHx7InJlbW90ZV9hZGRyZXNzIjoiMTkzLjEuMTg2LjI1MiIsInJlcXVlc3RfaWQiOiI2Q0VGOjZCMjU6RjNBMzE0OjE2Q0ZFNEI6NThEQTVFN0EiLCJ0aW1lc3RhbXAiOjE0OTA3MDYwNDksImhvc3QiOiJnaXRodWIuY29tIn0=">


  <meta name="html-safe-nonce" content="fb63ac2c15c66034c8ecf8f34dc3b7df8548db30">

  <meta http-equiv="x-pjax-version" content="ae1bea8bef645b5f7117f7ec82cd782b">
...
<meta name="theme-color" content="#1e2327">
  ...
  <!-- '"` --><!-- </textarea></xmp> --></option></form><form accept-charset="UTF-8" action="/calvinmetcalf/leaflet-ajax/search" class="js-site-search-form" data-scoped-search-url="/calvinmetcalf/leaflet-ajax/search" data-unscoped-search-url="/search" method="get"><div style="margin:0;padding:0;display:inline"><input name="utf8" type="hidden" value="&#x2713;" /></div>
    <label class="form-control header-search-wrapper js-chromeless-input-container">
        <a href="/calvinmetcalf/leaflet-ajax/blob/gh-pages/dist/leaflet.ajax.min.js" class="header-search-scope no-underline">This repository</a>
      <input type="text"
        ...
        <input type="hidden" class="js-site-search-type-field" name="type" >
          ...
          <a class="text-bold site-header-link" href="/login?return_to=%2Fcalvinmetcalf%2Fleaflet-ajax%2Fblob%2Fgh-pages%2Fdist%2Fleaflet.ajax.min.js" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in">Sign in</a>
...
<a href="/calvinmetcalf/leaflet-ajax/blob/1f7c87600efe3fecf782ffdff9d44c8142441204/dist/leaflet.ajax.min.js" class="d-none js-permalink-shortcut" data-hotkey="y">Permalink</a>

<!-- blob contrib key: blob_contributors:v21:9bf305410f0d690b8c06b3fe69ddf6f6 -->
    ...
    <div class="select-menu-modal">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/calvinmetcalf/leaflet-ajax/blob/ajax/dist/leaflet.ajax.min.js"
               data-name="ajax"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/calvinmetcalf/leaflet-ajax/blob/browserify/dist/leaflet.ajax.min.js"
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/calvinmetcalf/leaflet-ajax/blob/gh-pages/dist/leaflet.ajax.min.js"
               data-name="gh-pages"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/calvinmetcalf/leaflet-ajax/blob/headers/dist/leaflet.ajax.min.js"
               data-name="headers"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/calvinmetcalf/leaflet-ajax/blob/master/dist/leaflet.ajax.min.js"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/calvinmetcalf/leaflet-ajax/blob/promise/dist/leaflet.ajax.min.js"
               data-name="promise"
               data-skip-pjax="true"
               rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="tags">
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/calvinmetcalf/leaflet-ajax/tree/v2.1.0/dist/leaflet.ajax.min.js"
              data-name="v2.1.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/calvinmetcalf/leaflet-ajax/tree/v2.0.0/dist/leaflet.ajax.min.js"
              data-name="v2.0.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/calvinmetcalf/leaflet-ajax/tree/1.1.0/dist/leaflet.ajax.min.js"
              data-name="1.1.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/calvinmetcalf/leaflet-ajax/tree/1.0.0/dist/leaflet.ajax.min.js"
              data-name="1.0.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
              href="/calvinmetcalf/leaflet-ajax/tree/0.2.0/dist/leaflet.ajax.min.js"
              data-name="0.2.0"
              data-skip-pjax="true"
              rel="nofollow">
              <svg aria-hidden="true" class="octicon octicon-check select-menu-item-icon" height="16" version="1.1" viewBox="0 0 12 16" width="12"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5z"/></svg>
...
<div class="file">
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a href="/calvinmetcalf/leaflet-ajax/raw/gh-pages/dist/leaflet.ajax.min.js" class="btn btn-sm BtnGroup-item" id="raw-url">Raw</a>
        <a href="/calvinmetcalf/leaflet-ajax/blame/gh-pages/dist/leaflet.ajax.min.js" class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b">Blame</a>
      <a href="/calvinmetcalf/leaflet-ajax/commits/gh-pages/dist/leaflet.ajax.min.js" class="btn btn-sm BtnGroup-item" rel="nofollow">History</a>
    </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer" role="contentinfo">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2017 <span title="0.07096s from github-fe-bd32a9f.cp1-iad.github.net">GitHub</span>, Inc.</li>
  ...
  <div id="ajax-error-message" class="ajax-error-message flash flash-error">
    ...
    <script crossorigin="anonymous" integrity="sha256-WI24lF1ljQLbKQvbH94JPZPX8tnsLPUVC/7tAJH4HmI=" src="https://assets-cdn.github.com/assets/frameworks-588db8945d658d02db290bdb1fde093d93d7f2d9ec2cf5150bfeed0091f81e62.js"></script>
    <script async="async" crossorigin="anonymous" integrity="sha256-jqO8x04nCDTsCU3mkgSyjD5kLcMh/lnqilFr2n7k1Is=" src="https://assets-cdn.github.com/assets/github-8ea3bcc74e270834ec094de69204b28c3e642dc321fe59ea8a516bda7ee4d48b.js"></script>
