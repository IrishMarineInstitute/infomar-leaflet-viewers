...
function popupSurveys (feature, layer){
		...
		var surveyAreas = L.vectorGrid.slicer(surveyAreas, {
		rendererFactory: L.svg.tile,
			vectorTileLayerStyles: {
				sliced: function(properties, zoom) {
					var p = properties.YEAR;
					return {
						fillColor: p == 1996 ? '#800026' :
								p == 2002 ? '#E31A1C' :
								p == 2001 ? '#FEB24C' :
								p == 2003 ? '#B2FE4C' : '#FFEDA0',
						fillOpacity: 0.5,
						stroke: true,
						fill: true,
						color: 'black',
		...
		.on('click', function(e) {
			...
			var popupHTML ="<table class=\"tg\"><tr><th class=\"tg-9hbo\">Survey</th><th class=\"tg-yw4l\">" + props.SURVEY + "</th></tr><tr><td class=\"tg-9hbo\">Project</td><td class=\"tg-yw4l\">"+ props.Project+ "</td></tr><tr><td class=\"tg-9hbo\">Vessel</td><td class=\"tg-yw4l\">" + props.VesselName  +"</td></tr><tr><td class=\"tg-9hbo\">Year</td><td class=\"tg-yw4l\">"+  Math.round(props.YEAR) + "</td></tr>";
